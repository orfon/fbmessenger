 ...
 * @ignore
 */
GraphApiError.prototype = Error.prototype;

/**
 * @ignore
 */
GraphApiError.prototype.name = "GraphApiError";
...
const FBMessenger = exports.FBMessenger = function FBMessenger(pageAccessToken) {
     ...
     * @ignore
     */
    this.sendAttachment = function(type, id, attachment, notificationType, quickReplies) {
        let data = {
            "recipient": {
                "id": id
            },
        ...
        if (typeof attachment === "string" && strings.isUrl(attachment)) {
            data.message.payload.url = attachment;
 ...
 */
FBMessenger.prototype.sendImageAttachment = function(id, image, notificationType) {
    return this.sendAttachment("image", id, image, notificationType);
};
 ...
 */
FBMessenger.prototype.sendAudioAttachment = function(id, audio, notificationType) {
    return this.sendAttachment("audio", id, audio, notificationType);
};
 ...
 */
FBMessenger.prototype.sendVideoAttachment = function(id, video, notificationType) {
    return this.sendAttachment("video", id, video, notificationType);
};
 ...
 */
FBMessenger.prototype.sendFileAttachment = function(id, file, notificationType) {
    return this.sendAttachment("file", id, file, notificationType);
};
...
/**
 * Sends a template with a generic payload. This is useful to send receipt templates, airline templates, or other
 * specific templates not covered by the generic and button template call.
 * @param {string} id recipient user id
 ...
 * ]);
 */
FBMessenger.prototype.sendQuickReplies = function(id, attachmentOrText, quickReplies, notificationType) {
    if (typeof attachmentOrText === "string") {
        ...
        this.sendAttachment("image", id, attachmentOrText, notificationType, quickReplies);
    } else {
        return this._request("me/messages", {
            "recipient": {
                "id": id
