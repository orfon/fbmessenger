 ...
 * @param {string} type optional the code type to generate; default is <code>standard</code>
 * @param {string} imageSize optional image size of the code; defaults to 1000
 * @param {string} ref optional referral parameter containing only <code>a-z A-Z 0-9 +/=-.:_</code>
 ...
 * <em>uploadAttachment</em> you must specify it as an URL and not as an multipart attachment.
 * @param {string} type media type of the attachment, must be <code>image</code>, <code>audio</code>,
 *                      <code>video</code>, or <code>file</code>
